            ...
            <div className = {Individu.form}>
                ...
                <div className = {Individu.entry}>
                    <div className = {Individu.nama_panjang}>
                        <a> Nama Lengkap </a>
                        <input id = 'full_name' type = 'text' name = 'nama' placeholder='Aang Perak' required/> 
                    </div>
                    <div className = {Individu.nama_panggilan}>
                        <a> Nama Panggilan </a>
                        <input id = 'short_name' type = 'text' name = 'nama' placeholder='Aang Aja' required/> 
                    </div>
                    ...
                    <div className = {Individu.npm}>
                        <a> NPM </a>
                        <input id = 'npm' type = 'number' name = 'nama' placeholder='1900000000' min = '0' pattern={10} required/> 
                    </div>

                    <div className = {Individu.linewa}>
                        <a> ID Line / WhatsApp </a>
                        <input id = 'social_media' type = 'text' name = 'nama' placeholder='aangperak21' required/> 
                    </div>
                </div>
